...
function initWeSane(){
    ...
    loadText = newHtmlText("loadingText",
    "width:100%;text-align:center;position:absolute;top:60%;z-index:99;font-size:25px;color:#f99f0a");
    loadImg = newHtmlImg("loadingImg", "top:50%;align:center;width:100%;position:absolute;z-index:10;" , 
    "res/loading.gif",50,50);
    bgColor = newHtmlImg("bgColorImg", "align:center;width:100%;height:100%;position:absolute;" , 
    "res/singleColor.png", 5000 , 5000 );
