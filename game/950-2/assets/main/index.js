            ...
            return i(t, e),
                ...
                t.prototype.ComboShow = function () {
                    this.comboCount >= 2 && (this.comboLabel.string = this.comboCount.toString(),
                        ...
                        // 连击达到10，产生火球
                    this.comboCount % 2 == 0 && (this.readyToLaunchBubble.color = 9,
                        this.needHelp = !1,
                ...
                //     this.level < 2e4 ? this.bubbleColorRange = 3 : this.level <= 3e4 ? this.bubbleColorRange = 4 : this.level <= 5e4 ? (this.bubbleColorRange = 5,
                //         this.needHelp = !1) : this.level <= 8e4 ? this.bubbleColorRange = 6 : this.bubbleColorRange = 7
                // }
                t.prototype.ChangeDifficult = function () {
                    this.bubbleColorRange = 1
                }
                ,
                ...
                t.prototype.update = function () {
                    ...
                    if (this.bubbleStartMove && !this.canNotClickFlag) {
                        for (var e = 0, t = 9999, o = 0, n = 1; n <= 50; n++)
                            for (var i = 1; i <= 10; i++)
                                if (null != this.map[n][i].bubble) {
                                    if (o++,
                                    n > e && (e = n),
                                    speed == this.bubbleMoveSpeed && (this.map[n][i].bubble.y -= this.bubbleMoveSpeed),
                                    speed+0.05 == this.bubbleMoveSpeed && (this.map[n][i].bubble.y -= this.bubbleMoveSpeed),
                        ...
                        this.bubbleMoveSpeed = e < eDefault || o < oDefault ? 5 : speed;
                        var c = !1;
                        if (5 == this.bubbleMoveSpeed)
                            for (var r = 1; r <= 25; r++) {
                                ...
                                if (e < eDefault || oDefault < 45) {
                                    for (n = 1; n <= 50; n++)
                                        for (i = 1; i <= 10; i++)
                                            null != this.map[n][i].bubble && (this.map[n][i].bubble.y -= speed);
                                    this.bubbleMoveDistance += 2
                                } else
                                    c = !0,
                                        this.bubbleMoveSpeed = speed;
