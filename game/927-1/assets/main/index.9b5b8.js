window.__require = function e(t, o, n) {
    ...
    DataManager: [function (e, t, o) {
        ...
        var n = function () {
            ...
            }, e.cellSize = cc.v2(161, 140), e.cellScale = 1, e.cellL = e.cellSize.x * e.cellScale / 2, e.rowCount = 6, e.colCount = 5, e.top = 200, e.moveDownTime = .007, e.fillTime = 0.1, e.targetBottleScale = .025, e.beeMoveV = 1700, e.bottleSize = cc.v2(191, 212), e.bottleScale = 1, e
        }();
    ...
    GameUiTools: [function (e, t) {
        ...
        var o = {
            newSprite: function (e, t) {
                ...
                e.runAction(cc.sequence(cc.delayTime(o/10), cc.callFunc(t, e)))
    ...
    MainGameJS: [function (e, t) {
        ...
        cc.Class(((n = {
            extends: cc.Component, properties: {showAD: cc.Boolean}, onLoad: function () {
                ...
                i.GAME_OVER_BOOL = !1, r.gameOverShowText(i.gameScore, 1), this.node.runAction(cc.sequence(cc.delayTime(.05), cc.callFunc(this.gameEnd1.bind(this))))
            }, gameEnd1: function () {
                this.gameOveEndBool = !0, this.gameOverT1.string = r.gameEndLText, this.gameOverT2.string = r.gameEndL1Text, this.gameOverT1.node.zIndex = 999, this.gameOverT2.node.zIndex = 999, this.gameOverT1.node.opacity = 0, this.gameOverT1.node.y = 100, this.gameOverT1.node.runAction(cc.sequence(cc.delayTime(.02), cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.delayTime(.03), cc.callFunc(this.initEndLayer.bind(this)), cc.removeSelf())), this.gameOverT2.node.opacity = 0, this.gameOverT2.node.y = this.gameOverT1.node.y - 100, this.gameOverT2.node.runAction(cc.sequence(cc.delayTime(.02), cc.spawn(cc.fadeIn(1), cc.moveBy(1, 0, -50)), cc.delayTime(.03), cc.removeSelf()))
        ...
        var n = e("../../commonJs/utils"), a = e("../commons/DataManager"), i = e("../GS"), r = function () {
            ...
            return e.Bomb = function (e, t) {
                ...
                for (var a, r, c, s, l, u = n.default.getPrefabByName("Fragment"), h = function () {
                    ...
                    var n = e;
                    n.active = !0, n.opacity = 255, n.angle = 360 * Math.random(), a = 359 * Math.random(), r = 300 * Math.random() + 120, c = cc.v2(Math.sin(a * Math.PI / 180) * r, Math.cos(a * Math.PI / 180) * r), n.scale = Math.random() > .3 ? .7 + .3 * Math.random() : .2 * Math.random() + .2, n.zIndex = 3, n.runAction(cc.sequence(cc.delayTime(2 / 3 * .05), cc.fadeOut(1 / 3 * .5))), s = Math.floor(100 * Math.random()) > 49, l = s ? 1 : -1, n.runAction(cc.sequence(cc.spawn(cc.moveBy(.5, c), cc.rotateBy(.5, 540 * l)), cc.callFunc(function () {
        ...
        var c = e("../../commonJs/GameConfig"), s = e("../../commonJs/utils"), l = e("../commons/DataManager"),
            u = e("../GS"), h = e("./Particle"), d = cc._decorator, p = d.ccclass, f = d.property, g = function (e) {
                ...
                return a(t, e), t.prototype.onLoad = function () {
                    ...
                    // 此处修改物品出现概率
                    // 蜂蜜 树枝 木板 三个木板 空桶 满桶 炸弹 总和需大于1
                    e = t < 3e9 ? [.5, 0, 0, 0, 0, 0.5, 0] : t < 6e3 ? [.02, .3, .4, .3, 0, 0, 0] : t < 12e3 ? [.03, .4, .4, .15, .05, 0, 0] : t < 15e3 ? [.04, .35, .3, .25, .05, .05, 0] : t < 17e3 ? [.05, .35, .25, .2, .15, .05, 0] : t < 2e4 ? [.06, .2, .35, .3, .1, .05, 0] : [.07, .3, .32, .25, .1, .03, 0];
                    ...
                    if (a && -1 == a.getComponent("Item").itemLevel) {
                        n.item = null;
                        var i = 0;
                        u.default.AudioManager.playSound("sounds/fill", !1, .3), a.getChildByName("Fill").getComponent(cc.Animation).play().speed = 10, cc.log("\u6ef4\u5165\u871c\u7f50\u4e2d"), this.currentBottle.getComponent("Bottle").fill() || (i = l.default.fillTime, this.scheduleOnce(function () {
                            e.changeBottle(!0)
                        }, i));
    ...
    linkHttpIconJs: [function (e, t) {
        ...
        cc.Class({
            extends: cc.Component, properties: {iconSpr: cc.Node, iconSpr1: cc.Node}, onLoad: function () {
                ...
                var e, t;
                e = null != o.recGameDelPau ? o.recGameDelPau : 6, cc.log("dMainManager.recGameDelPer", o.recGameDelPer), t = null != o.recGameDelPer ? o.recGameDelPer : .7, this._imageArr[0].opacity = 255, this._imageArr[0].runAction(cc.repeatForever(cc.sequence(cc.delayTime(e/10), cc.rotateBy(t, 0, 180), cc.callFunc(function () {
                    this._imageArr[0].setRotation(0), this._imageArr[0].opacity = 0, this._imageArr[1].opacity = 255
                }, this), cc.delayTime(e/10), cc.callFunc(function () {
                    this.flowerAction(this._imageArr[1], t)
                }, this), cc.delayTime(t/10), cc.callFunc(function () {
